...
namespace CRM.BL.WF {
    ...
    public partial class CanAddAnOrder : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(CanAddAnOrder).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(CanAddAnOrder));
        ...
        private string FindResource() {
            string[] resources = typeof(CanAddAnOrder).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".CanAddAnOrder.g.xaml") || resource.Equals("CanAddAnOrder.g.xaml"))) {
                    return resource;
                }
            }
